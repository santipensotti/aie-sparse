...
using DATATYPE_IN1 = uint32_t;
using DATATYPE_IN2 = uint32_t;
using DATATYPE_OUT = uint32_t;
const int SIZE=16;
void initialize_bufIn1(DATATYPE_IN1 *bufIn1) {
...
int verify_spmv(DATATYPE_IN1 *bufIn1, DATATYPE_IN2 *bufIn2,
                             DATATYPE_OUT *bufOut, int verbosity) {
    int cols = SIZE;
    int nnz = SIZE;
    int errors = 0;
    DATATYPE_IN1* rowptr = bufIn1;
...
int main(int argc, const char *argv[]) {
  ...
  auto bo_inA = xrt::bo(device, IN_SIZE * sizeof(int32_t) * 3,
  ...
  int errors = verify_spmv(bufInA, bufInB, bufOut, verbosity);
