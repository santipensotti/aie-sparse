...
def my_matmul(dev):
    ...
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            zero = external_func(f"zero_{dtype_out_str}", inputs=[outC_ty])
            matvec = external_func(
                f"matvec_{dtype_in_str}_{dtype_out_str}",
            ...
            def sequence(A, B, C):
                ...
                for i in range(n_cores):
                    ...
                    # Problema de este approach es que no se puede
